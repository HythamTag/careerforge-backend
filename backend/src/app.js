...
app.use('/v1/pdf-generations', CvGenerationModule.routes);
app.use('/v1/ats-analyses', CvAtsModule.routes);
app.use('/v1/parsing-jobs', CvParsingModule.routes);
app.use('/v1/optimization-jobs', CvOptimizerModule.routes);
